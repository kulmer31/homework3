...
r = requests.get('https://www.sec.gov/Archives/edgar/data/323493/000129019318000145/0087520193/DASH-18-000145.txt')
r = requests.get('https://www.sec.gov/Archives/edgar/data/0001347187/890139718716700013/UBER-20180128x10k.txt')
raw_10k = r.text
